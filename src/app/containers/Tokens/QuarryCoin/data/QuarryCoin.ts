export const bennifitData = [
  {
    ...
    text: 'With Quarry you’ll be able to experience lightning fast transactions (20,000 - 100,000 TPS), thanks to its Delegated Proof of Stake Network.',
    border_p: 'left',
  },
  {
  ...
  },
  {
    ...
    text: 'Quarry is an environmentally friendly digital currency that produces zero carbon emissions, this is all because Specialized Computer Hardware (ASICS) will not be required to have or maintain in order to become a Quarry',
    border_p: 'right',
  },
]
